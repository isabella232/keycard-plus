...
public class SECP256k1 {
  ...
  short blsSign(byte[] privateKey, short privateKeyOff, byte[] hash, short hashOff, byte[] out, short outOff) {
    Util.arrayCopyNonAtomic(privateKey, privateKeyOff, sigBuf, (short) 0, BLS_SK_SIZE);    
