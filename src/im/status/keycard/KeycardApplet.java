...
public class KeycardApplet extends Applet {
  ...
  private void generateMnemonic(APDU apdu) {
    ...
    crypto.random.nextBytes(apduBuffer, GENERATE_MNEMONIC_TMP_OFF, entLen);
  ...
  private void generateKey(APDU apdu) {
    ...
    crypto.random.nextBytes(apduBuffer, ISO7816.OFFSET_CDATA, BIP39_SEED_SIZE);
  ...
  private void sign(APDU apdu) {
    ...
    outLen += secp256k1.ecdsaDeterministicSign(crypto, signingKey, apduBuffer, ISO7816.OFFSET_CDATA, apduBuffer, sigOff);
